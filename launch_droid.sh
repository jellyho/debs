...
export JOBNAME="droid_new_10k"
export data_dir="/data5/jellyho/droid_rl/droid_dataset_mixed/"
export save_dir="/data5/jellyho/lql_droid_insert_10k/"
...
# for task in "pnp_carrot" "refill_tape" "eggplant_bin" "plug_in_bulb"; do
