...
export JOBNAME="QCFQL_FINAL_BIG"
export MODEL="qcfql"
...
for task_num in "1" "2" "3" '4' "5"; do
    for seed in "100" "200" "300"; do
        ...
        sbatch --exclude=node19,node16 -p ${PART} -q ${QOS} --gres=gpu:1 -o ~/.slurm_logs/${JOBNAME}_${TASK}_${task_num}_${seed}.log debs_ogbench.sh ${TASK} ${MODEL} ${LATENT} ${ALPHA} ${JOBNAME} ${task_num} ${seed}
    done
done
export ALPHA="10.0"
